...
public class StreamInfoItemHolder extends StreamMiniInfoItemHolder {
    ...
    public StreamInfoItemHolder(InfoItemBuilder infoItemBuilder, ViewGroup parent) {
        super(infoItemBuilder, org.tube.player.R.layout.list_stream_item, parent);
        itemAdditionalDetails = itemView.findViewById(org.tube.player.R.id.itemAdditionalDetails);
    }
