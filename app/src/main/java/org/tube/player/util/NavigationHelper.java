...
import org.tube.player.fragments.MainFragment;
...
import org.tube.player.fragments.list.playlist.PlaylistFragment;
import org.tube.player.fragments.list.search.SearchFragment;
import org.tube.player.history.HistoryActivity;
import org.tube.player.player.BackgroundPlayer;
import org.tube.player.player.BackgroundPlayerActivity;
import org.tube.player.player.BasePlayer;
import org.tube.player.player.MainVideoPlayer;
import org.tube.player.player.PopupVideoPlayer;
import org.tube.player.player.PopupVideoPlayerActivity;
import org.tube.player.player.VideoPlayer;
...
public class NavigationHelper {
    ...
    public static void playOnPopupPlayer(final Activity activity, final PlayQueue queue) {
        ...
        Toast.makeText(activity, org.tube.player.R.string.popup_playing_toast, Toast.LENGTH_SHORT).show();
    ...
    public static void playOnBackgroundPlayer(final Context context, final PlayQueue queue) {
        Toast.makeText(context, org.tube.player.R.string.background_player_playing_toast, Toast.LENGTH_SHORT).show();
    ...
    public static void enqueueOnPopupPlayer(final Activity activity, final PlayQueue queue) {
        ...
        Toast.makeText(activity, org.tube.player.R.string.popup_playing_append, Toast.LENGTH_SHORT).show();
        activity.startService(getPlayerEnqueueIntent(activity, PopupVideoPlayer.class, queue));
        FacebookReport.logSentPopupPageShow();
    }

    public static void enqueueOnBackgroundPlayer(final Context context, final PlayQueue queue) {
        Toast.makeText(context, org.tube.player.R.string.background_player_append, Toast.LENGTH_SHORT).show();
    ...
    public static void openMainFragment(FragmentManager fragmentManager) {
        ...
        fragmentManager.beginTransaction()
                .setCustomAnimations(org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out, org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out)
                .replace(org.tube.player.R.id.fragment_holder, new MainFragment())
    ...
    public static void openSearchFragment(FragmentManager fragmentManager, int serviceId, String query) {
        fragmentManager.beginTransaction()
                .setCustomAnimations(org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out, org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out)
                .replace(org.tube.player.R.id.fragment_holder, SearchFragment.getInstance(serviceId, query))
                .addToBackStack(null)
                .commitAllowingStateLoss();
    }
    ...
    public static void openVideoDetailFragment(FragmentManager fragmentManager, int serviceId, String url, String title, boolean autoPlay) {
        Fragment fragment = fragmentManager.findFragmentById(org.tube.player.R.id.fragment_holder);
        if (title == null) title = "";
        ...
        fragmentManager.beginTransaction()
                .setCustomAnimations(org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out, org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out)
                .replace(org.tube.player.R.id.fragment_holder, instance)
                .addToBackStack(null)
                .commitAllowingStateLoss();
    }
    ...
    public static void openChannelFragment(FragmentManager fragmentManager, int serviceId, String url, String name) {
        ...
        fragmentManager.beginTransaction()
                .setCustomAnimations(org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out, org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out)
                .replace(org.tube.player.R.id.fragment_holder, ChannelFragment.getInstance(serviceId, url, name))
                .addToBackStack(null)
                .commitAllowingStateLoss();
    }
    ...
    public static void openPlaylistFragment(FragmentManager fragmentManager, int serviceId, String url, String name) {
        ...
        fragmentManager.beginTransaction()
                .setCustomAnimations(org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out, org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out)
                .replace(org.tube.player.R.id.fragment_holder, PlaylistFragment.getInstance(serviceId, url, name))
                .addToBackStack(null)
                .commitAllowingStateLoss();
    }
    ...
    public static void openWhatsNewFragment(FragmentManager fragmentManager) {
        fragmentManager.beginTransaction()
                .setCustomAnimations(org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out, org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out)
                .replace(org.tube.player.R.id.fragment_holder, new FeedFragment())
                .addToBackStack(null)
                .commitAllowingStateLoss();
    }
    ...
    public static void openKioskFragment(FragmentManager fragmentManager, int serviceId, String kioskId)
        ...
        fragmentManager.beginTransaction()
                .setCustomAnimations(org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out, org.tube.player.R.animator.custom_fade_in, org.tube.player.R.animator.custom_fade_out)
                .replace(org.tube.player.R.id.fragment_holder, KioskFragment.getInstance(serviceId, kioskId))
                .addToBackStack(null)
                .commitAllowingStateLoss();
    }
        ...
        switch (linkType) {
            case STREAM:
                rIntent.putExtra(VideoDetailFragment.AUTO_PLAY, PreferenceManager.getDefaultSharedPreferences(context)
                        .getBoolean(context.getString(org.tube.player.R.string.autoplay_through_intent_key), false));
                break;
        }
    ...
    public static void installKore(Context context) {
        installApp(context, context.getString(org.tube.player.R.string.kore_package));
    }
    ...
    public static void playWithKore(Context context, Uri videoURL) {
        ...
        intent.setPackage(context.getString(org.tube.player.R.string.kore_package));
