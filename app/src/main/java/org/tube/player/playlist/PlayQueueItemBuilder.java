...
public class PlayQueueItemBuilder {
    ...
    public PlayQueueItemBuilder(final Context context) {
        thumbnailWidthPx = context.getResources().getDimensionPixelSize(org.tube.player.R.dimen.play_queue_thumbnail_width);
        thumbnailHeightPx = context.getResources().getDimensionPixelSize(org.tube.player.R.dimen.play_queue_thumbnail_height);
    ...
    private DisplayImageOptions buildImageOptions(final int widthPx, final int heightPx) {
        ...
        return new DisplayImageOptions.Builder()
                .showImageOnFail(org.tube.player.R.drawable.dummy_thumbnail)
                .showImageForEmptyUri(org.tube.player.R.drawable.dummy_thumbnail)
                .showImageOnLoading(org.tube.player.R.drawable.dummy_thumbnail)
