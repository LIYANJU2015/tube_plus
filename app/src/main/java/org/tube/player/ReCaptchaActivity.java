...
public class ReCaptchaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.tube.player.R.layout.activity_recaptcha);
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(org.tube.player.R.string.reCaptcha_title);
            actionBar.setDisplayShowTitleEnabled(true);
        }

        WebView myWebView = findViewById(org.tube.player.R.id.reCaptchaWebView);
