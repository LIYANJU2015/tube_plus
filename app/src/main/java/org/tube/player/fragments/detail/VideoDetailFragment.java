package org.tube.player.fragments.detail;
...
import org.tube.player.fragments.BaseStateFragment;
...
import org.tube.player.player.old.PlayVideoActivity;
        ...
        return new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                    AnimationUtils.animateView(appendControlsDetail, true, 250, 0, new Runnable() {
                        @Override
                        public void run() {
        ...
        if (!TextUtils.isEmpty(info.getThumbnailUrl())) {
            imageLoader.displayImage(info.getThumbnailUrl(), thumbnailImageView, DISPLAY_THUMBNAIL_OPTIONS, new SimpleImageLoadingListener() {
                ...
                public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                    try {
                        if (activity != null && failReason != null) {
