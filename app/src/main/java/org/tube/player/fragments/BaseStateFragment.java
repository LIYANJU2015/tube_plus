...
import org.tube.player.util.InfoCache;
...
public abstract class BaseStateFragment<I> extends BaseFragment implements ViewContract<I> {
    ...
    protected void initViews(View rootView, Bundle savedInstanceState) {
        ...
        emptyStateView = rootView.findViewById(org.tube.player.R.id.empty_state_view);
        loadingProgressBar = rootView.findViewById(org.tube.player.R.id.loading_progress_bar);

        errorPanelRoot = rootView.findViewById(org.tube.player.R.id.error_panel);
        errorButtonRetry = rootView.findViewById(org.tube.player.R.id.error_button_retry);
        errorTextView = rootView.findViewById(org.tube.player.R.id.error_message_view);
    }
    ...
    protected boolean onError(Throwable exception) {
        ...
        if (exception instanceof ReCaptchaException) {
            ...
            showError(getString(org.tube.player.R.string.network_error), true);
            return true;
        }
    ...
    public void onReCaptchaException() {
        ...
        Toast.makeText(activity, org.tube.player.R.string.recaptcha_request_toast, Toast.LENGTH_LONG).show();
        // Starting ReCaptcha Challenge Activity
        startActivityForResult(new Intent(activity, ReCaptchaActivity.class), ReCaptchaActivity.RECAPTCHA_REQUEST);

        showError(getString(org.tube.player.R.string.recaptcha_request_toast), false);
    }
    ...
    protected void openUrlInBrowser(String url) {
        ...
        startActivity(Intent.createChooser(intent, activity.getString(org.tube.player.R.string.share_dialog_title)));
    }
    ...
    protected void shareUrl(String subject, String url) {
        ...
        startActivity(Intent.createChooser(intent, getString(org.tube.player.R.string.share_dialog_title)));
    }
}
