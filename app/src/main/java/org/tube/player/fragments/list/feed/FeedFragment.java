package org.tube.player.fragments.list.feed;
...
import org.tube.player.fragments.list.BaseListFragment;
...
public class FeedFragment extends BaseListFragment<List<SubscriptionEntity>, Void> {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(org.tube.player.R.layout.fragment_feed, container, false);
    }
    ...
    private int howManyItemsToLoad() {
        ...
        int itemHeightPixels = activity.getResources().getDimensionPixelSize(org.tube.player.R.dimen.video_item_search_height);
