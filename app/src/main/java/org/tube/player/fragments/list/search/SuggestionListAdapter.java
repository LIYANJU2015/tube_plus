package org.tube.player.fragments.list.search;
...
public class SuggestionListAdapter extends RecyclerView.Adapter<SuggestionListAdapter.SuggestionItemHolder> {
    ...
    public SuggestionItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SuggestionItemHolder(LayoutInflater.from(context).inflate(org.tube.player.R.layout.item_search_suggestion, parent, false));
    }
    ...
    public static class SuggestionItemHolder extends RecyclerView.ViewHolder {
        ...
        private SuggestionItemHolder(View rootView) {
            super(rootView);
            suggestionIcon = rootView.findViewById(org.tube.player.R.id.item_suggestion_icon);
            itemSuggestionQuery = rootView.findViewById(org.tube.player.R.id.item_suggestion_query);

            queryView = rootView.findViewById(org.tube.player.R.id.suggestion_search);
            insertView = rootView.findViewById(org.tube.player.R.id.suggestion_insert);

            historyResId = resolveResourceIdFromAttr(rootView.getContext(), org.tube.player.R.attr.history);
            searchResId = resolveResourceIdFromAttr(rootView.getContext(), org.tube.player.R.attr.search);
        }
