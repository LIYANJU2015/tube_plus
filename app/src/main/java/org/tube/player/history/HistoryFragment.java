package org.tube.player.history;
...
public abstract class HistoryFragment<E extends HistoryEntry> extends BaseFragment
        ...
        mHistoryItemSwipeCallback = new ItemTouchHelper.SimpleCallback(0, swipeDirection) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                if (mHistoryAdapter != null) {
                    ...
                    View view = getActivity().findViewById(org.tube.player.R.id.main_content);
                    if (view == null) view = mRecyclerView.getRootView();

                    Snackbar.make(view, org.tube.player.R.string.item_deleted, 5 * 1000)
                            .setActionTextColor(Color.WHITE)
                            .setAction(org.tube.player.R.string.undo, new View.OnClickListener() {
                                @Override
    ...
    public void onHistoryCleared() {
        ...
        if (!itemsToDelete.isEmpty()) {
            Snackbar.make(view, org.tube.player.R.string.history_cleared, 5 * 1000)
                    .setActionTextColor(Color.WHITE)
                    .setAction(org.tube.player.R.string.undo, new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
            ...
            Snackbar.make(view, org.tube.player.R.string.history_cleared, Snackbar.LENGTH_LONG).show();
        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(org.tube.player.R.layout.fragment_history, container, false);
        mRecyclerView = rootView.findViewById(org.tube.player.R.id.history_view);
        ...
        mDisabledView = rootView.findViewById(org.tube.player.R.id.history_disabled_view);
        mEmptyHistoryView = rootView.findViewById(org.tube.player.R.id.history_empty);
