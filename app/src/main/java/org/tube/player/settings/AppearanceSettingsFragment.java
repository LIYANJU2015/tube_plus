...
public class AppearanceSettingsFragment extends BasePreferenceFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String themeKey = getString(org.tube.player.R.string.theme_key);
        startThemeKey = defaultPreferences.getString(themeKey, getString(org.tube.player.R.string.default_theme_value));
        findPreference(themeKey).setOnPreferenceChangeListener(themePreferenceChange);
    }

    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        addPreferencesFromResource(org.tube.player.R.xml.appearance_settings);
    }
    ...
    private Preference.OnPreferenceChangeListener themePreferenceChange = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            defaultPreferences.edit().putString(getString(org.tube.player.R.string.theme_key), newValue.toString()).apply();
