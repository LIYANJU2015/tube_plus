...
import org.tube.player.fragments.subscription.SubscriptionService;
...
public class SelectChannelFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(org.tube.player.R.layout.select_channel_fragment, container, false);
        recyclerView = (RecyclerView) v.findViewById(org.tube.player.R.id.items_list);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        channelAdapter = new SelectChannelAdapter();
        recyclerView.setAdapter(channelAdapter);

        progressBar = v.findViewById(org.tube.player.R.id.progressBar);
        emptyView = v.findViewById(org.tube.player.R.id.empty_state_view);
    ...
    private class SelectChannelAdapter extends
        ...
        public SelectChannelItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View item = LayoutInflater.from(parent.getContext())
                    .inflate(org.tube.player.R.layout.select_channel_item, parent, false);
        ...
        public class SelectChannelItemHolder extends RecyclerView.ViewHolder {
            public SelectChannelItemHolder(View v) {
                super(v);
                this.view = v;
                thumbnailView = v.findViewById(org.tube.player.R.id.itemThumbnailView);
                titleView = v.findViewById(org.tube.player.R.id.itemTitleView);
            }
            public View view;
